...
from src.api import get_object_by_shortname, get_objects


@mark.unittest
def test__unittest__api__get_object_by_shortname(mocker):
    mocker.patch(
    ...
    expected_value = '[{"id": "None", "title": "project one", "shortname": "proj-1", ' \
                     '"description": "description of project one"}]'
    actual_value = get_object_by_shortname("project", "proj-1")
