...
@mark.nightly
def test__nightly__streamlit_app__delete_item_and_verify_task_deletion(two_fully_set_up_projects, selenium_util):
    ...
    test_page = get_item_page_url_by_title(Requirement, "alpha_1")
    selenium_util.go_to_page(test_page)
    selenium_util.submit_form_by_text("Delete")
    selenium_util.click_link_text("Tasks")
    affected_items = ["task-0", "task-2", "task-3", "task-5", "task-6"]
